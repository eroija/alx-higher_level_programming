...
class Rectangle:
    ...
    def area(self):
        ...
        """
        Public instance method to calculate and return the rectangle area.
    ...
    def perimeter(self):
        ...
        """
        Public instance method to calculate and return the rectangle perimeter.
    ...
    def __str__(self):
        ...
        """
        String representation of the rectangle using the symbol stored
        in print_symbol.
